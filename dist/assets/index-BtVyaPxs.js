(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function e(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=e(s);fetch(s.href,o)}})();class Z{constructor(){this.routes={},this.currentRoute=null,window.addEventListener("hashchange",()=>this._onHashChange())}addRoute(t,e){this.routes[t]=e}navigate(t){window.location.hash=t}getCurrentPath(){return window.location.hash.slice(1)||"/"}_onHashChange(){const t=this.getCurrentPath();this._resolve(t)}_resolve(t){const e=this.routes[t]||this.routes["/"];e&&(this.currentRoute=t,e(t))}start(){const t=this.getCurrentPath();this._resolve(t)}}const x=new Z,X=Object.freeze(Object.defineProperty({__proto__:null,default:x,router:x},Symbol.toStringTag,{value:"Module"})),B="cipta_finansial_data",I={family:null,accounts:[],transactions:[],assets:{emas:{bsi_gram:0,tring_gram:0,price_per_gram:165e4},kpr:{total:0,paid:0,monthly:0,bank:"",remaining_months:0},arisan:[]},settings:{togetherMode:!1,allowanceBudget:15e5,userName:"Erwin",spouseName:"Bunda"},categories:[]};class tt{constructor(){this._listeners=[],this._state=this._load()}_load(){try{const t=localStorage.getItem(B);if(t){const e=JSON.parse(t);return{...I,...e}}}catch(t){console.warn("Failed to load state",t)}return{...I}}_save(){try{localStorage.setItem(B,JSON.stringify(this._state))}catch(t){console.warn("Failed to save state",t)}this._notify()}_notify(){this._listeners.forEach(t=>t(this._state))}subscribe(t){return this._listeners.push(t),()=>{this._listeners=this._listeners.filter(e=>e!==t)}}getState(){return this._state}setFamily(t){this._state.family=t,this._save()}updateSettings(t){this._state.settings={...this._state.settings,...t},this._save()}toggleTogetherMode(){return this._state.settings.togetherMode=!this._state.settings.togetherMode,this._save(),this._state.settings.togetherMode}addAccount(t){const n=this._state.accounts.reduce((s,o)=>Math.max(s,o.id||0),0)+1;return this._state.accounts.push({id:n,...t}),this._save(),n}updateAccount(t,e){const n=this._state.accounts.findIndex(s=>s.id===t);n!==-1&&(this._state.accounts[n]={...this._state.accounts[n],...e},this._save())}deleteAccount(t){this._state.accounts=this._state.accounts.filter(e=>e.id!==t),this._save()}getAccounts(){return this._state.accounts}getAccountById(t){return this._state.accounts.find(e=>e.id===t)}addTransaction(t){const e=crypto.randomUUID?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).substr(2),n={id:e,created_at:new Date().toISOString(),...t};return this._state.transactions.unshift(n),t.type==="income"?this._updateAccountBalance(t.account_id,t.amount):t.type==="expense"?this._updateAccountBalance(t.account_id,-t.amount):t.type==="transfer"&&(this._updateAccountBalance(t.account_id,-t.amount),t.to_account_id&&this._updateAccountBalance(t.to_account_id,t.amount)),this._save(),e}_updateAccountBalance(t,e){const n=this._state.accounts.find(s=>s.id===t);n&&(n.balance=(n.balance||0)+e)}deleteTransaction(t){const e=this._state.transactions.find(n=>n.id===t);e&&(e.type==="income"?this._updateAccountBalance(e.account_id,-e.amount):e.type==="expense"?this._updateAccountBalance(e.account_id,e.amount):e.type==="transfer"&&(this._updateAccountBalance(e.account_id,e.amount),e.to_account_id&&this._updateAccountBalance(e.to_account_id,-e.amount)),this._state.transactions=this._state.transactions.filter(n=>n.id!==t),this._save())}getTransactions(t={}){let e=[...this._state.transactions];if(t.type&&(e=e.filter(n=>n.type===t.type)),t.paid_by&&(e=e.filter(n=>n.paid_by===t.paid_by)),t.for_whom&&(e=e.filter(n=>n.for_whom===t.for_whom)),t.account_id&&(e=e.filter(n=>n.account_id===t.account_id)),t.parent_category&&(e=e.filter(n=>n.parent_category===t.parent_category)),t.month&&(e=e.filter(n=>{const s=new Date(n.created_at);return s.getMonth()===t.month&&s.getFullYear()===(t.year||new Date().getFullYear())})),t.search){const n=t.search.toLowerCase();e=e.filter(s=>(s.description||"").toLowerCase().includes(n)||(s.parent_category||"").toLowerCase().includes(n)||(s.sub_category||"").toLowerCase().includes(n))}return e}getTransactionsByMonth(t,e){return this._state.transactions.filter(n=>{const s=new Date(n.created_at);return s.getFullYear()===t&&s.getMonth()===e})}updateAssets(t){this._state.assets={...this._state.assets,...t},this._save()}updateEmas(t){this._state.assets.emas={...this._state.assets.emas,...t},this._save()}updateKPR(t){this._state.assets.kpr={...this._state.assets.kpr,...t},this._save()}addArisan(t){const e=Date.now();return this._state.assets.arisan.push({id:e,...t}),this._save(),e}getAssets(){return this._state.assets}getTotalBalance(){return this._state.accounts.reduce((t,e)=>t+(e.balance||0),0)}getMonthlyExpenses(t,e){return this.getTransactionsByMonth(t,e).filter(n=>n.type==="expense").reduce((n,s)=>n+s.amount,0)}getMonthlyIncome(t,e){return this.getTransactionsByMonth(t,e).filter(n=>n.type==="income").reduce((n,s)=>n+s.amount,0)}getAllowanceSpent(){const t=new Date;return this.getTransactionsByMonth(t.getFullYear(),t.getMonth()).filter(e=>e.type==="expense"&&e.paid_by==="Suami").reduce((e,n)=>e+n.amount,0)}getDanaPusatBalance(){return this._state.accounts.filter(t=>t.owner_name==="Istri"||t.owner_name==="Bersama").reduce((t,e)=>t+(e.balance||0),0)}getNetWorth(){const t=this.getTotalBalance(),e=this._state.assets.emas,n=(e.bsi_gram+e.tring_gram)*e.price_per_gram,s=this._state.assets.kpr.paid;return t+n+s}getCategorySpending(t,e){const n=this.getTransactionsByMonth(t,e).filter(o=>o.type==="expense"),s={};return n.forEach(o=>{const i=o.parent_category||"Lainnya";s[i]=(s[i]||0)+o.amount}),Object.entries(s).map(([o,i])=>({name:o,amount:i})).sort((o,i)=>i.amount-o.amount)}reset(){this._state=JSON.parse(JSON.stringify(I)),localStorage.removeItem(B),this._notify()}}const l=new tt,F=4;function et(){const a=localStorage.getItem("cipta_seed_version");if(a&&parseInt(a)>=F&&l.getState().accounts.length>0)return;l.reset(),l.setFamily({id:"family-001",family_name:"Keluarga Erwin",created_at:new Date().toISOString()}),l.updateSettings({userName:"Pak Erwin",spouseName:"Bunda",allowanceBudget:15e5});const t=l.addAccount({bank_name:"BRI",owner_name:"Suami",balance:85e5,is_allowance_account:!1,css_class:"bri"}),e=l.addAccount({bank_name:"Bank Jago",owner_name:"Bersama",balance:32e5,is_allowance_account:!0,css_class:"jago"}),n=l.addAccount({bank_name:"BSI",owner_name:"Istri",balance:12e6,is_allowance_account:!1,css_class:"bsi"});l.updateEmas({bsi_gram:15.5,tring_gram:3.2,price_per_gram:165e4}),l.updateKPR({total:25e7,paid:875e5,monthly:21e5,bank:"BTN",remaining_months:96}),l.addArisan({name:"Arisan Kantor Dinas",monthly_amount:2e5,total_members:15,my_turn:8,current_round:3,is_active:!0}),l.addArisan({name:"Arisan Ibu PKK",monthly_amount:15e4,total_members:20,my_turn:14,current_round:5,is_active:!0});const s=new Date,o=s.getFullYear(),i=s.getMonth(),r=[{account_id:t,amount:72e5,type:"income",description:"Gaji Pokok + Tunjangan April",parent_category:"Gaji & Pendapatan",sub_category:"Gaji Pokok",paid_by:"Suami",for_whom:"Bersama",created_at:new Date(o,i,1,8,0).toISOString()},{account_id:t,amount:35e5,type:"income",description:"TPP Bulan April",parent_category:"Gaji & Pendapatan",sub_category:"TPP",paid_by:"Suami",for_whom:"Bersama",created_at:new Date(o,i,5,10,0).toISOString()},{account_id:t,amount:65e5,type:"transfer",description:"Transfer Dana Pusat ke BSI Istri",parent_category:"Transfer",sub_category:"Pindah Buku",paid_by:"Suami",for_whom:"Bersama",to_account_id:n,created_at:new Date(o,i,1,9,0).toISOString()},{account_id:t,amount:15e5,type:"transfer",description:"Pegangan Suami ke Jago",parent_category:"Transfer",sub_category:"Pindah Buku",paid_by:"Suami",for_whom:"Suami",to_account_id:e,created_at:new Date(o,i,1,9,30).toISOString()},{account_id:e,amount:15e4,type:"expense",description:"Bensin Raize Perjalanan LDM",parent_category:"Transportasi",sub_category:"Bensin LDM",paid_by:"Suami",for_whom:"Suami",created_at:new Date(o,i,2,7,30).toISOString()},{account_id:e,amount:35e3,type:"expense",description:"Tol Barru - Makassar",parent_category:"Transportasi",sub_category:"Tol",paid_by:"Suami",for_whom:"Suami",created_at:new Date(o,i,2,8,0).toISOString()},{account_id:e,amount:25e3,type:"expense",description:"Makan Siang Warung Pak Baso",parent_category:"Makanan & Minuman",sub_category:"Makan Harian",paid_by:"Suami",for_whom:"Suami",created_at:new Date(o,i,3,12,0).toISOString()},{account_id:e,amount:15e3,type:"expense",description:"Kopi Kenangan",parent_category:"Makanan & Minuman",sub_category:"Kopi & Minuman",paid_by:"Suami",for_whom:"Suami",created_at:new Date(o,i,3,15,0).toISOString()},{account_id:e,amount:15e4,type:"expense",description:"Bensin Raize Harian",parent_category:"Transportasi",sub_category:"Bensin Harian",paid_by:"Suami",for_whom:"Suami",created_at:new Date(o,i,5,7,0).toISOString()},{account_id:e,amount:2e5,type:"expense",description:"Arisan Kantor Bulan Ini",parent_category:"Sosial & Ibadah",sub_category:"Arisan",paid_by:"Suami",for_whom:"Suami",created_at:new Date(o,i,6,10,0).toISOString()},{account_id:n,amount:35e4,type:"expense",description:"Belanja Bulanan Indomaret",parent_category:"Makanan & Minuman",sub_category:"Groceries",paid_by:"Istri",for_whom:"Bersama",created_at:new Date(o,i,2,10,0).toISOString()},{account_id:n,amount:5e5,type:"expense",description:"SPP TK Aisyah Bulan April",parent_category:"Pendidikan Anak",sub_category:"SPP",paid_by:"Istri",for_whom:"Anak",created_at:new Date(o,i,3,9,0).toISOString()},{account_id:n,amount:18e4,type:"expense",description:"Listrik Rumah B",parent_category:"Rumah Tangga",sub_category:"Listrik",paid_by:"Istri",for_whom:"Bersama",created_at:new Date(o,i,4,11,0).toISOString()},{account_id:n,amount:21e5,type:"expense",description:"Cicilan KPR BTN April",parent_category:"Cicilan",sub_category:"KPR",paid_by:"Istri",for_whom:"Bersama",created_at:new Date(o,i,5,8,0).toISOString()},{account_id:n,amount:15e4,type:"expense",description:"Arisan Ibu PKK",parent_category:"Sosial & Ibadah",sub_category:"Arisan",paid_by:"Istri",for_whom:"Istri",created_at:new Date(o,i,6,14,0).toISOString()},{account_id:n,amount:85e3,type:"expense",description:"Vitamin & Susu Anak",parent_category:"Kesehatan",sub_category:"Vitamin",paid_by:"Istri",for_whom:"Anak",created_at:new Date(o,i,7,10,0).toISOString()},{account_id:e,amount:25e4,type:"expense",description:"Makan Keluarga di Restoran",parent_category:"Hiburan",sub_category:"Quality Time",paid_by:"Suami",for_whom:"Bersama",is_together:!0,created_at:new Date(o,i,7,19,0).toISOString()},{account_id:e,amount:45e3,type:"expense",description:"Es Krim untuk Anak",parent_category:"Makanan & Minuman",sub_category:"Cemilan",paid_by:"Suami",for_whom:"Anak",is_together:!0,created_at:new Date(o,i,7,20,0).toISOString()},{account_id:n,amount:825e3,type:"expense",description:"Beli Emas BSI 0.5 gram",parent_category:"Investasi",sub_category:"Emas BSI",paid_by:"Istri",for_whom:"Bersama",created_at:new Date(o,i,8,9,0).toISOString()}],c=l.getState();r.forEach(d=>{const u=crypto.randomUUID?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).substr(2);c.transactions.push({id:u,...d})}),c.transactions.sort((d,u)=>new Date(u.created_at)-new Date(d.created_at)),localStorage.setItem("cipta_finansial_data",JSON.stringify(c)),localStorage.setItem("cipta_seed_version",F.toString())}const at="modulepreload",nt=function(a){return"/Admfb/"+a},q={},T=function(t,e,n){let s=Promise.resolve();if(e&&e.length>0){let i=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=i(e.map(d=>{if(d=nt(d),d in q)return;q[d]=!0;const u=d.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":at,u||(g.as="script"),g.crossOrigin="",g.href=d,c&&g.setAttribute("nonce",c),document.head.appendChild(g),u)return new Promise((h,v)=>{g.addEventListener("load",h),g.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return s.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return t().catch(o)})};function st(){const a=l.getState(),t=a.settings.togetherMode;return`
  ...
  `}function it(){const a=document.getElementById("together-toggle");a&&a.addEventListener("click",()=>{const t=l.toggleTogetherMode();a.classList.toggle("active",t);const e=a.querySelector(".together-toggle-icon"),n=a.querySelector(".together-toggle-label");e.textContent=t?"favorite":"favorite_border",n.textContent=t?"Together!":"Together",T(async()=>{const{showToast:s}=await Promise.resolve().then(()=>mt);return{showToast:s}},void 0).then(({showToast:s})=>{s(t?"💕 Together Mode Aktif!":"Together Mode Nonaktif","info")})})}const ot=[{path:"/",icon:"dashboard",label:"Beranda"},{path:"/transactions",icon:"receipt_long",label:"Transaksi"},{path:"/accounts",icon:"account_balance_wallet",label:"Rekening"},{path:"/assets",icon:"diamond",label:"Aset"},{path:"/insights",icon:"auto_awesome",label:"AI Insight"}];function rt(){const a=x.getCurrentPath();return`
  ...
  `}function ct(a){document.querySelectorAll(".nav-item").forEach(t=>{const e=t.getAttribute("href");t.classList.toggle("active",e===`#${a}`)})}function dt(){return`
  ...
  `}function lt(){var s,o,i,r;const a=document.getElementById("fab-main"),t=document.getElementById("fab-actions");let e=!1;a&&a.addEventListener("click",()=>{e=!e,a.classList.toggle("open",e),t.classList.toggle("open",e)}),document.addEventListener("click",c=>{e&&!c.target.closest("#fab-container")&&(e=!1,a==null||a.classList.remove("open"),t==null||t.classList.remove("open"))}),(s=document.getElementById("fab-expense"))==null||s.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-transaction-modal",{detail:{type:"expense"}})),n()}),(o=document.getElementById("fab-income"))==null||o.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-transaction-modal",{detail:{type:"income"}})),n()}),(i=document.getElementById("fab-transfer"))==null||i.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-transaction-modal",{detail:{type:"transfer"}})),n()}),(r=document.getElementById("fab-scan"))==null||r.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-scan-modal")),n()});function n(){e=!1,a==null||a.classList.remove("open"),t==null||t.classList.remove("open")}}const E=[{name:"Makanan & Minuman",icon:"restaurant",subs:["Makan Harian","Makan di Luar","Cemilan","Kopi & Minuman","Groceries"]},{name:"Transportasi",icon:"directions_car",subs:["Bensin LDM","Bensin Harian","Parkir","Tol","Servis Kendaraan","Ojol / Grab"]},{name:"Rumah Tangga",icon:"home",subs:["Listrik","Air PDAM","Internet","Gas LPG","Perabot","Kebersihan"]},{name:"Pendidikan Anak",icon:"school",subs:["SPP","Buku & Alat Tulis","Les/Kursus","Seragam","Uang Jajan"]},{name:"Kesehatan",icon:"local_hospital",subs:["Obat","Dokter","Vitamin","BPJS Tambahan"]},{name:"Pakaian & Fashion",icon:"checkroom",subs:["Pakaian","Sepatu","Aksesoris"]},{name:"Hiburan",icon:"celebration",subs:["Jalan-jalan","Quality Time","Film","Langganan Digital","Hobi"]},{name:"Sosial & Ibadah",icon:"volunteer_activism",subs:["Sedekah","Zakat","Sumbangan","Hajatan","Arisan"]},{name:"Investasi",icon:"trending_up",subs:["Emas BSI","Emas Tring","Tabungan","Deposito"]},{name:"Cicilan",icon:"account_balance",subs:["KPR","Kredit Motor","Pinjaman"]},{name:"Gaji & Pendapatan",icon:"payments",subs:["Gaji Pokok","Tunjangan Kinerja","TPP","Penghasilan Lain","Arisan Masuk"]},{name:"Lainnya",icon:"more_horiz",subs:["Tak Terduga","Donasi","Lain-lain"]}];function ut(a){const t=E.find(e=>e.name===a);return t?t.icon:"receipt_long"}function pt(a){const t=E.find(e=>e.name===a);return t?t.subs:[]}function p(a,t=!1){return t&&Math.abs(a)>=1e6?"Rp "+(a/1e6).toFixed(1).replace(".0","")+" jt":t&&Math.abs(a)>=1e3?"Rp "+(a/1e3).toFixed(0)+" rb":new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0,maximumFractionDigits:0}).format(a)}function U(a,t="long"){const e=new Date(a),n=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],s=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],o=["Minggu","Senin","Selasa","Rabu","Kamis","Jumat","Sabtu"];if(t==="short")return`${e.getDate()} ${n[e.getMonth()]}`;if(t==="long")return`${o[e.getDay()]}, ${e.getDate()} ${s[e.getMonth()]} ${e.getFullYear()}`;if(t==="time")return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`;if(t==="relative"){const r=new Date-e,c=Math.floor(r/6e4);if(c<1)return"Baru saja";if(c<60)return`${c} menit lalu`;const d=Math.floor(c/60);if(d<24)return`${d} jam lalu`;const u=Math.floor(d/24);return u===1?"Kemarin":u<7?`${u} hari lalu`:`${e.getDate()} ${n[e.getMonth()]}`}if(t==="group"){const i=new Date,r=new Date(i);return r.setDate(r.getDate()-1),e.toDateString()===i.toDateString()?"Hari Ini":e.toDateString()===r.toDateString()?"Kemarin":`${o[e.getDay()]}, ${e.getDate()} ${n[e.getMonth()]}`}return e.toLocaleDateString("id-ID")}function w(){return["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"][new Date().getMonth()]}function Y(a){const t={};return a.forEach(e=>{const n=U(e.created_at,"group");t[n]||(t[n]=[]),t[n].push(e)}),t}function _(a,t="info"){let e=document.querySelector(".toast-container");e||(e=document.createElement("div"),e.className="toast-container",document.body.appendChild(e));const n=document.createElement("div");n.className=`toast toast-${t}`,n.textContent=a,e.appendChild(n),setTimeout(()=>n.remove(),3e3)}function W(a,t=300){let e;return(...n)=>{clearTimeout(e),e=setTimeout(()=>a(...n),t)}}function k(a,t){return t?Math.min(Math.round(a/t*100),100):0}const mt=Object.freeze(Object.defineProperty({__proto__:null,debounce:W,formatDate:U,formatRupiah:p,getCurrentMonthName:w,groupByDate:Y,percentage:k,showToast:_},Symbol.toStringTag,{value:"Module"}));function gt(){const a=l.getAccounts(),t=l.getState();return`
          ...
          <div class="form-row" id="tx-category-row">
            <div class="form-group">
              ...
              <select class="form-select" id="tx-category">
                ...
                ${E.map(e=>`<option value="${e.name}">${e.name}</option>`).join("")}
              </select>
            </div>
            <div class="form-group">
  ...
  `}function vt(){var e;const a=document.getElementById("tx-modal-backdrop");document.getElementById("tx-modal-sheet");const t=document.getElementById("tx-form");window.addEventListener("open-transaction-modal",n=>{var s;yt(((s=n.detail)==null?void 0:s.type)||"expense")}),a==null||a.addEventListener("click",G),document.querySelectorAll("#tx-type-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#tx-type-chips .chip").forEach(r=>r.classList.remove("selected")),n.classList.add("selected");const s=n.dataset.type,o=document.getElementById("tx-to-account-group"),i=document.getElementById("tx-category-row");o&&(o.style.display=s==="transfer"?"":"none"),i&&(i.style.display=s==="transfer"?"none":"")})}),document.querySelectorAll("#tx-paid-by-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#tx-paid-by-chips .chip").forEach(s=>s.classList.remove("selected")),n.classList.add("selected")})}),document.querySelectorAll("#tx-for-whom-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#tx-for-whom-chips .chip").forEach(s=>s.classList.remove("selected")),n.classList.add("selected")})}),(e=document.getElementById("tx-category"))==null||e.addEventListener("change",n=>{const s=pt(n.target.value),o=document.getElementById("tx-subcategory");o&&(o.innerHTML='<option value="">Pilih Sub-Kategori</option>'+s.map(i=>`<option value="${i}">${i}</option>`).join(""))}),t==null||t.addEventListener("submit",n=>{var S,L,D,z,C,j,R,O,K,N;n.preventDefault();const s=((S=document.querySelector("#tx-type-chips .chip.selected"))==null?void 0:S.dataset.type)||"expense",o=parseFloat(((L=document.getElementById("tx-amount"))==null?void 0:L.value)||0),i=((D=document.getElementById("tx-description"))==null?void 0:D.value)||"",r=parseInt((z=document.getElementById("tx-account"))==null?void 0:z.value),c=s==="transfer"?parseInt((C=document.getElementById("tx-to-account"))==null?void 0:C.value):null,d=((j=document.getElementById("tx-category"))==null?void 0:j.value)||"",u=((R=document.getElementById("tx-subcategory"))==null?void 0:R.value)||"",m=((O=document.querySelector("#tx-paid-by-chips .chip.selected"))==null?void 0:O.dataset.value)||"Suami",g=((K=document.querySelector("#tx-for-whom-chips .chip.selected"))==null?void 0:K.dataset.value)||"Bersama",h=(N=document.getElementById("tx-date"))==null?void 0:N.value,v=h?new Date(h).toISOString():new Date().toISOString(),f=l.getState();if(!o||o<=0){_("Masukkan nominal yang valid","error");return}l.addTransaction({account_id:r,to_account_id:c,amount:o,type:s,description:i,parent_category:s==="transfer"?"Transfer":d,sub_category:s==="transfer"?"Pindah Buku":u,paid_by:m,for_whom:g,is_together:f.settings.togetherMode,created_at:v}),_("✅ Transaksi berhasil disimpan!"),G(),window.dispatchEvent(new CustomEvent("data-updated"))})}function yt(a="expense"){var c;const t=document.getElementById("tx-modal-backdrop"),e=document.getElementById("tx-modal-sheet"),n=document.getElementById("tx-modal-title");(c=document.getElementById("tx-form"))==null||c.reset(),document.getElementById("tx-date").value=new Date().toISOString().slice(0,16),document.querySelectorAll("#tx-type-chips .chip").forEach(d=>{d.classList.toggle("selected",d.dataset.type===a)});const s=document.getElementById("tx-to-account-group"),o=document.getElementById("tx-category-row");s&&(s.style.display=a==="transfer"?"":"none"),o&&(o.style.display=a==="transfer"?"none":""),l.getState().settings.togetherMode&&(document.querySelectorAll("#tx-paid-by-chips .chip").forEach(d=>{d.classList.toggle("selected",d.dataset.value==="Istri")}),document.querySelectorAll("#tx-for-whom-chips .chip").forEach(d=>{d.classList.toggle("selected",d.dataset.value==="Bersama")}));const r={expense:"Tambah Pengeluaran",income:"Tambah Pemasukan",transfer:"Transfer Antar Rekening"};n&&(n.textContent=r[a]||"Tambah Transaksi"),t==null||t.classList.add("open"),e==null||e.classList.add("open")}function G(){var a,t;(a=document.getElementById("tx-modal-backdrop"))==null||a.classList.remove("open"),(t=document.getElementById("tx-modal-sheet"))==null||t.classList.remove("open")}const ht="AIzaSyDqFQw69x7-Bboft5GRDQvc9T5ZrDQ7Szo",ft=`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${ht}`;function bt(){return`
  ...
  `}let y=null;function _t(){var s;const a=document.getElementById("scan-modal-backdrop"),t=document.getElementById("scan-modal-sheet"),e=document.getElementById("scan-upload-area"),n=document.getElementById("scan-file-input");window.addEventListener("open-scan-modal",()=>{a==null||a.classList.add("open"),t==null||t.classList.add("open"),document.getElementById("scan-preview").style.display="none",document.getElementById("scan-result").style.display="none",document.getElementById("scan-loading").style.display="none",document.getElementById("scan-parsed-data").style.display="none",document.getElementById("scan-save-btn").style.display="none",y=null}),a==null||a.addEventListener("click",()=>{a==null||a.classList.remove("open"),t==null||t.classList.remove("open")}),e==null||e.addEventListener("click",()=>n==null?void 0:n.click()),n==null||n.addEventListener("change",async o=>{var c;const i=(c=o.target.files)==null?void 0:c[0];if(!i)return;const r=new FileReader;r.onload=async d=>{const u=d.target.result;document.getElementById("scan-preview-img").src=u,document.getElementById("scan-preview").style.display="block",document.getElementById("scan-loading").style.display="block",document.getElementById("scan-result").style.display="none";try{await kt(u.split(",")[1],i.type)}catch(m){console.error("AI Error:",m),document.getElementById("scan-loading").style.display="none",document.getElementById("scan-result").style.display="block",document.getElementById("scan-ai-text").textContent="❌ Gagal menganalisis gambar. Silakan coba lagi atau input manual."}},r.readAsDataURL(i)}),(s=document.getElementById("scan-save-btn"))==null||s.addEventListener("click",()=>{var r;if(!y)return;const i=(r=l.getAccounts()[0])==null?void 0:r.id;l.addTransaction({account_id:i,amount:y.amount||0,type:y.type||"expense",description:y.description||"Transaksi dari Scan",parent_category:y.category||"Lainnya",sub_category:y.sub_category||"",paid_by:l.getState().settings.togetherMode?"Istri":"Suami",for_whom:l.getState().settings.togetherMode?"Bersama":"Suami",is_together:l.getState().settings.togetherMode,created_at:y.date?new Date(y.date).toISOString():new Date().toISOString()}),_("✅ Transaksi dari scan berhasil disimpan!"),a==null||a.classList.remove("open"),t==null||t.classList.remove("open"),window.dispatchEvent(new CustomEvent("data-updated"))})}async function kt(a,t){var r,c,d,u,m,g;const n=`Analisis gambar struk/nota/slip gaji berikut. Ekstrak informasi keuangan dan kembalikan dalam format JSON SAJA (tanpa markdown):
{
  ...
  "category": salah satu dari [${E.map(h=>h.name).join(", ")}],
...
Jika ini slip gaji PNS, ekstrak: Gaji Pokok, Tunjangan, Potongan, dan Total Take Home Pay. Set type ke "income" dan amount ke take home pay.`,i=((m=(u=(d=(c=(r=(await(await fetch(ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:n},{inline_data:{mime_type:t||"image/jpeg",data:a}}]}],generationConfig:{temperature:.1,maxOutputTokens:1024}})})).json()).candidates)==null?void 0:r[0])==null?void 0:c.content)==null?void 0:d.parts)==null?void 0:u[0])==null?void 0:m.text)||"";document.getElementById("scan-loading").style.display="none",document.getElementById("scan-result").style.display="block";try{const h=i.match(/\{[\s\S]*\}/);if(h){y=JSON.parse(h[0]),document.getElementById("scan-ai-text").innerHTML=`
      ...
      `,document.getElementById("scan-save-btn").style.display="flex"}else document.getElementById("scan-ai-text").textContent=i||"Tidak dapat mengekstrak data dari gambar ini."}catch{document.getElementById("scan-ai-text").textContent=i||"Gagal memproses respons AI."}}function xt(){const a=l.getState(),t=new Date,e=a.settings.allowanceBudget||15e5,n=l.getAllowanceSpent(),s=Math.max(0,e-n),o=k(n,e),i=l.getDanaPusatBalance(),r=l.getMonthlyExpenses(t.getFullYear(),t.getMonth()),c=l.getMonthlyIncome(t.getFullYear(),t.getMonth());return`
    <div class="bento-grid stagger-children">
      ...
      <div class="card" id="card-total-balance">
        ...
        <div class="card-value" style="font-size: 1.5rem; color: var(--primary);">${p(l.getTotalBalance())}</div>
      ...
      <div class="card" id="card-cash-flow">
        ...
        <div style="display: flex; gap: 12px; margin-top: 8px;">
          <div>
            ...
            <div style="font-size: 14px; font-weight: 700; color: var(--success);">${p(c,!0)}</div>
          </div>
          <div>
  ...
  `}function wt(a){const t=a.toLowerCase();return t.includes("bri")?"bri":t.includes("jago")?"jago":t.includes("bsi")?"bsi":"default"}function St(a){const t=a.toLowerCase();return t.includes("bri")?"BRI":t.includes("jago")?"JGO":t.includes("bsi")?"BSI":a.slice(0,3).toUpperCase()}function Et(){return`
    ...
    <div class="bank-slider" id="bank-slider">
      ${l.getAccounts().map(t=>{const e=wt(t.bank_name);return`
  ...
  `}function Bt(){const a=document.getElementById("btn-add-account");a&&a.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-account-modal"))});const t=document.getElementById("btn-manage-accounts");t&&t.addEventListener("click",()=>{T(async()=>{const{default:e}=await Promise.resolve().then(()=>X);return{default:e}},void 0).then(({default:e})=>e.navigate("/accounts"))})}function It(){const a=l.getState(),t=new Date,e=l.getTransactionsByMonth(t.getFullYear(),t.getMonth()),n=a.assets.kpr,s=k(n.paid,n.total),o=6e5,i=e.filter(m=>m.type==="expense"&&m.parent_category==="Transportasi").reduce((m,g)=>m+g.amount,0),r=k(i,o),c=8e5,d=e.filter(m=>m.type==="expense"&&m.for_whom==="Anak").reduce((m,g)=>m+g.amount,0),u=k(d,c);return`
    <div class="section-header">
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;" class="stagger-children">
      ...
      <div class="analysis-card">
        ...
        <div class="analysis-card-detail">
          <span>Terpakai: ${p(d,!0)}</span>
          <span>Budget: ${p(c,!0)}</span>
        </div>
      </div>
    </div>
  `}function P(a=10,t={}){let e=l.getTransactions(t);const n=e.length;if(a&&(e=e.slice(0,a)),e.length===0)return`
      <div class="empty-state">
        <span class="material-icons-round">receipt_long</span>
        <h3>Belum Ada Transaksi</h3>
        <p>Mulai catat pengeluaran dan pemasukan Anda</p>
      </div>
    `;const s=Y(e);let o="";return Object.entries(s).forEach(([i,r])=>{o+=`<div class="transaction-group-header">${i}</div>`,r.forEach(c=>{const d=ut(c.parent_category),u=c.type,m=c.type==="expense"?"-":c.type==="income"?"+":"↔",g=l.getAccountById(c.account_id),h=g?g.bank_name:"";o+=`
        <div class="transaction-item" data-tx-id="${c.id}">
          <div class="transaction-icon ${u}">
            <span class="material-icons-round">${d}</span>
          </div>
          <div class="transaction-info">
            <div class="transaction-desc">${c.description}</div>
            <div class="transaction-meta">
              <span class="badge badge-${(c.paid_by||"").toLowerCase()}">${c.paid_by||"-"}</span>
              ${c.is_together?'<span class="badge badge-together">💕</span>':""}
              <span>${c.sub_category||c.parent_category||""}</span>
            </div>
          </div>
          <div class="transaction-amount">
            <div class="transaction-amount-value ${u}">${m} ${p(c.amount)}</div>
    ...
    `),o}function M(){document.querySelectorAll(".transaction-item").forEach(a=>{a.addEventListener("click",()=>{const t=a.dataset.txId;window.dispatchEvent(new CustomEvent("view-transaction",{detail:{id:t}}))})})}function $t(){const a=l.getState();return`
  ...
  `}function At(){Bt(),M()}function Tt(){const a=new Date().getHours();return a<11?"Selamat Pagi":a<15?"Selamat Siang":a<18?"Selamat Sore":"Selamat Malam"}let b={};function Pt(){const a=new Date,t=l.getMonthlyExpenses(a.getFullYear(),a.getMonth()),e=l.getMonthlyIncome(a.getFullYear(),a.getMonth()),n=e-t;return`
  ...
  `}function Mt(){M(),document.querySelectorAll("#tx-filters .chip").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll("#tx-filters .chip").forEach(n=>n.classList.remove("selected")),t.classList.add("selected");const e=t.dataset.filter;e==="all"?delete b.type:b.type=e,$()})}),document.querySelectorAll("#tx-paid-filter .chip").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll("#tx-paid-filter .chip").forEach(n=>n.classList.remove("selected")),t.classList.add("selected");const e=t.dataset.paid;e==="all"?delete b.paid_by:b.paid_by=e,$()})});const a=document.getElementById("tx-search");a&&a.addEventListener("input",W(t=>{const e=t.target.value.trim();e?b.search=e:delete b.search,$()},300)),Lt()}function $(){const a=document.getElementById("filtered-transactions");a&&(a.innerHTML=P(null,b),M())}async function Lt(){const a=document.getElementById("category-chart");if(a)try{const t=await T(()=>import("./auto-eE5P6S0m.js"),[]),e=t.default||t.Chart,n=new Date,s=l.getCategorySpending(n.getFullYear(),n.getMonth());if(s.length===0){a.parentElement.innerHTML=`
      ...
      `;return}const o=["#30609d","#9a6a1a","#1b6d2f","#ba1a1a","#7b1fa2","#00695c","#e65100","#283593","#4e342e","#546e7a","#ad1457","#00838f"];new e(a,{type:"doughnut",data:{labels:s.map(i=>i.name),datasets:[{data:s.map(i=>i.amount),backgroundColor:o.slice(0,s.length),borderWidth:2,borderColor:"#fff",hoverOffset:6}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"65%",plugins:{legend:{position:"bottom",labels:{padding:12,usePointStyle:!0,pointStyleWidth:8,font:{family:"'Plus Jakarta Sans'",size:11,weight:"600"}}},tooltip:{callbacks:{label:i=>{const r=i.dataset.data.reduce((d,u)=>d+u,0),c=Math.round(i.parsed/r*100);return` ${i.label}: ${p(i.parsed)} (${c}%)`}},titleFont:{family:"'Plus Jakarta Sans'"},bodyFont:{family:"'Plus Jakarta Sans'"}}}}})}catch(t){console.warn("Chart.js not loaded:",t)}}function Dt(){const a=l.getAccounts(),t=l.getTotalBalance();return`
  ...
  `}function zt(a){const t=V(a.bank_name);return`
  ...
  `}function jt(){var e;const a=document.getElementById("btn-add-new-account"),t=document.getElementById("acc-modal-backdrop");document.getElementById("acc-modal-sheet"),a==null||a.addEventListener("click",()=>J()),window.addEventListener("open-account-modal",()=>J()),t==null||t.addEventListener("click",()=>H()),document.querySelectorAll("#acc-owner-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#acc-owner-chips .chip").forEach(s=>s.classList.remove("selected")),n.classList.add("selected")})}),(e=document.getElementById("acc-form"))==null||e.addEventListener("submit",n=>{var c,d,u,m,g;n.preventDefault();const s=(d=(c=document.getElementById("acc-bank-name"))==null?void 0:c.value)==null?void 0:d.trim(),o=((u=document.querySelector("#acc-owner-chips .chip.selected"))==null?void 0:u.dataset.value)||"Suami",i=parseFloat(((m=document.getElementById("acc-balance"))==null?void 0:m.value)||0),r=((g=document.getElementById("acc-is-allowance"))==null?void 0:g.checked)||!1;if(!s){_("Masukkan nama bank","error");return}l.addAccount({bank_name:s,owner_name:o,balance:i,is_allowance_account:r,css_class:V(s).replace("bank-card-icon ","")}),_("✅ Rekening berhasil ditambahkan!"),H(),window.dispatchEvent(new CustomEvent("data-updated"))}),document.querySelectorAll(".btn-delete-account").forEach(n=>{n.addEventListener("click",s=>{s.stopPropagation();const o=parseInt(n.dataset.accId);confirm("Hapus rekening ini?")&&(l.deleteAccount(o),_("Rekening dihapus"),window.dispatchEvent(new CustomEvent("data-updated")))})})}function J(){var a,t,e;(a=document.getElementById("acc-form"))==null||a.reset(),(t=document.getElementById("acc-modal-backdrop"))==null||t.classList.add("open"),(e=document.getElementById("acc-modal-sheet"))==null||e.classList.add("open")}function H(){var a,t;(a=document.getElementById("acc-modal-backdrop"))==null||a.classList.remove("open"),(t=document.getElementById("acc-modal-sheet"))==null||t.classList.remove("open")}function V(a){const t=a.toLowerCase();return t.includes("bri")?"bri":t.includes("jago")?"jago":t.includes("bsi")?"bsi":"default"}function Rt(a){const t=a.toLowerCase();return t.includes("bri")?"BRI":t.includes("jago")?"JGO":t.includes("bsi")?"BSI":a.slice(0,3).toUpperCase()}function Ot(){const a=l.getAssets(),t=l.getNetWorth(),e=l.getTotalBalance(),n=a.emas,s=n.bsi_gram+n.tring_gram,o=s*n.price_per_gram,i=a.kpr,r=k(i.paid,i.total),c=i.total-i.paid,d=a.arisan||[];return`
      ...
      <div class="asset-card" id="asset-kpr">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
          ...
          <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px;">
            ...
            <div style="font-size: 14px; font-weight: 800; color: var(--error); margin-top: 4px;">${p(c,!0)}</div>
          </div>
          <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px;">
      ...
      <div class="asset-card" id="asset-arisan">
        <div class="asset-card-header">
          ...
          <div>
            ...
            <div class="asset-card-subtitle">${d.length} kelompok arisan aktif</div>
          </div>
        </div>
  ...
  `}function Kt(){}function Nt(){l.getState();const a=new Date,t=Ft();return`
  ...
  `}function Ft(){const a=new Date,t=l.getState(),n=l.getTransactionsByMonth(a.getFullYear(),a.getMonth()).filter(v=>v.type==="expense"),s=n.reduce((v,f)=>v+f.amount,0),o=t.settings.allowanceBudget||15e5,i=l.getAllowanceSpent(),r=[],c=Math.round(i/o*100);c>=80?r.push({title:"Budget Alert",icon:"warning",color:"#e53935",message:`Pegangan ${t.settings.userName} sudah mencapai ${c}% budget. Sisa ${p(o-i)} untuk bulan ini.`,detail:`Budget: ${p(o)} | Terpakai: ${p(i)}`}):c>=50&&r.push({title:"Pemantauan Budget",icon:"info",color:"#fb8c00",message:`${t.settings.userName}, pegangan sudah terpakai ${c}%. Masih ada ${p(o-i)} untuk sisa bulan ini.`,detail:null});const d=n.filter(v=>v.parent_category==="Transportasi").reduce((v,f)=>v+f.amount,0);d>0&&r.push({title:"Transportasi",icon:"directions_car",color:"#9a6a1a",message:`Total pengeluaran transportasi bulan ini: ${p(d)}. ${d>5e5?"Cukup tinggi, pertimbangkan efisiensi perjalanan LDM.":"Masih terkendali, pertahankan!"}`,detail:null});const u=5e5,m=n.filter(v=>v.sub_category==="Groceries"||v.parent_category==="Makanan & Minuman").reduce((v,f)=>v+f.amount,0);m<u&&m>0&&r.push({title:"Apresiasi! 🎉",icon:"celebration",color:"#43a047",message:`${t.settings.spouseName}, bulan ini pengeluaran makanan & groceries ${p(m,!0)}. Hemat ${p(u-m,!0)} yang bisa dialokasikan ke investasi emas!`,detail:null});const g=n.filter(v=>v.is_together);if(g.length>0){const v=g.reduce((f,S)=>f+S.amount,0);r.push({title:"Quality Time 💕",icon:"favorite",color:"#e91e63",message:`Bulan ini ada ${g.length} transaksi saat Together Mode aktif, total ${p(v)}. Waktu berkualitas bersama keluarga itu priceless!`,detail:null})}const h=n.filter(v=>v.for_whom==="Anak").reduce((v,f)=>v+f.amount,0);return h>0&&r.push({title:"Keperluan Anak",icon:"child_care",color:"#1565c0",message:`Total pengeluaran untuk anak bulan ini: ${p(h)}. Investasi terbaik adalah pendidikan anak.`,detail:null}),r.push({title:"Ringkasan Bulanan",icon:"summarize",color:"#30609d",message:`Total pengeluaran ${w()}: ${p(s)} dari ${n.length} transaksi. Saya terus memantau dan akan memberikan insight yang lebih akurat seiring bertambahnya data.`,detail:null}),r}function qt(){var n;const a=new Date,t=l.getCategorySpending(a.getFullYear(),a.getMonth());if(t.length===0)return'<div style="text-align: center; padding: 20px; color: var(--outline);">Belum ada data</div>';const e=((n=t[0])==null?void 0:n.amount)||1;return`
    <div class="card">
      ${t.map((s,o)=>{const i=Math.round(s.amount/e*100),r=["#30609d","#9a6a1a","#1b6d2f","#ba1a1a","#7b1fa2","#00695c","#e65100","#283593"],c=r[o%r.length];return`
          <div style="margin-bottom: 12px;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 4px;">
              <span style="font-size: 13px; font-weight: 600; color: var(--on-surface);">${s.name}</span>
              <span style="font-size: 13px; font-weight: 700; color: ${c};">${p(s.amount,!0)}</span>
            </div>
            <div style="width: 100%; height: 6px; background: var(--surface-container); border-radius: 3px; overflow: hidden;">
              <div style="width: ${i}%; height: 100%; background: ${c}; border-radius: 3px; transition: width 0.8s ease;"></div>
            </div>
          </div>
        `}).join("")}
    </div>
  `}function Gt(){}const Jt=document.getElementById("app"),A={"/":{render:$t,init:At},"/transactions":{render:Pt,init:Mt},"/accounts":{render:Dt,init:jt},"/assets":{render:Ot,init:Kt},"/insights":{render:Nt,init:Gt}};function Q(a){const t=A[a]||A["/"];Jt.innerHTML=`
    ${st()}
    ${rt()}
    ${t.render()}
    ${dt()}
    ${gt()}
    ${bt()}
  `,it(),lt(),vt(),_t(),t.init(),ct(a),window.scrollTo({top:0,behavior:"instant"})}Object.keys(A).forEach(a=>{x.addRoute(a,Q)});window.addEventListener("data-updated",()=>{const a=x.getCurrentPath();Q(a)});function Ht(){et(),x.start()}document.addEventListener("DOMContentLoaded",Ht);
