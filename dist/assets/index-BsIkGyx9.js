(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();class se{constructor(){this.routes={},this.currentRoute=null,window.addEventListener("hashchange",()=>this._onHashChange())}addRoute(e,t){this.routes[e]=t}navigate(e){window.location.hash=e}getCurrentPath(){return window.location.hash.slice(1)||"/"}_onHashChange(){const e=this.getCurrentPath();this._resolve(e)}_resolve(e){const t=this.routes[e]||this.routes["/"];t&&(this.currentRoute=e,t(e))}start(){const e=this.getCurrentPath();this._resolve(e)}}const M=new se,ie=Object.freeze(Object.defineProperty({__proto__:null,default:M,router:M},Symbol.toStringTag,{value:"Module"})),j="cipta_finansial_data",R={family:null,accounts:[],transactions:[],assets:{emas:{bsi_gram:0,tring_gram:0,price_per_gram:165e4},kpr:{total:0,paid:0,monthly:0,bank:"",remaining_months:0},arisan:[]},settings:{togetherMode:!1,allowanceBudget:15e5,userName:"Erwin",spouseName:"Nihad",geminiApiKey:""},categories:[]};class oe{constructor(){this._listeners=[],this._state=this._load()}_load(){try{const e=localStorage.getItem(j);if(e){const t=JSON.parse(e);return{...R,...t}}}catch(e){console.warn("Failed to load state",e)}return{...R}}_save(){try{localStorage.setItem(j,JSON.stringify(this._state))}catch(e){console.warn("Failed to save state",e)}this._notify()}_notify(){this._listeners.forEach(e=>e(this._state))}subscribe(e){return this._listeners.push(e),()=>{this._listeners=this._listeners.filter(t=>t!==e)}}getState(){return this._state}setFamily(e){this._state.family=e,this._save()}updateSettings(e){this._state.settings={...this._state.settings,...e},this._save()}toggleTogetherMode(){return this._state.settings.togetherMode=!this._state.settings.togetherMode,this._save(),this._state.settings.togetherMode}addAccount(e){const n=this._state.accounts.reduce((s,i)=>Math.max(s,i.id||0),0)+1;return this._state.accounts.push({id:n,...e}),this._save(),n}updateAccount(e,t){const n=this._state.accounts.findIndex(s=>s.id===e);n!==-1&&(this._state.accounts[n]={...this._state.accounts[n],...t},this._save())}deleteAccount(e){this._state.accounts=this._state.accounts.filter(t=>t.id!==e),this._save()}getAccounts(){return this._state.accounts}getAccountById(e){return this._state.accounts.find(t=>t.id===e)}addTransaction(e){const t=crypto.randomUUID?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).substr(2),n={id:t,created_at:new Date().toISOString(),...e};return this._state.transactions.unshift(n),e.type==="income"?this._updateAccountBalance(e.account_id,e.amount):e.type==="expense"?this._updateAccountBalance(e.account_id,-e.amount):e.type==="transfer"&&(this._updateAccountBalance(e.account_id,-e.amount),e.to_account_id&&this._updateAccountBalance(e.to_account_id,e.amount)),this._save(),t}_updateAccountBalance(e,t){const n=this._state.accounts.find(s=>s.id===e);n&&(n.balance=(n.balance||0)+t)}deleteTransaction(e){const t=this._state.transactions.find(n=>n.id===e);t&&(t.type==="income"?this._updateAccountBalance(t.account_id,-t.amount):t.type==="expense"?this._updateAccountBalance(t.account_id,t.amount):t.type==="transfer"&&(this._updateAccountBalance(t.account_id,t.amount),t.to_account_id&&this._updateAccountBalance(t.to_account_id,-t.amount)),this._state.transactions=this._state.transactions.filter(n=>n.id!==e),this._save())}getTransactions(e={}){let t=[...this._state.transactions];if(e.type&&(t=t.filter(n=>n.type===e.type)),e.paid_by&&(t=t.filter(n=>n.paid_by===e.paid_by)),e.for_whom&&(t=t.filter(n=>n.for_whom===e.for_whom)),e.account_id&&(t=t.filter(n=>n.account_id===e.account_id)),e.parent_category&&(t=t.filter(n=>n.parent_category===e.parent_category)),e.month&&(t=t.filter(n=>{const s=new Date(n.created_at);return s.getMonth()===e.month&&s.getFullYear()===(e.year||new Date().getFullYear())})),e.search){const n=e.search.toLowerCase();t=t.filter(s=>(s.description||"").toLowerCase().includes(n)||(s.parent_category||"").toLowerCase().includes(n)||(s.sub_category||"").toLowerCase().includes(n))}return t}getTransactionsByMonth(e,t){return this._state.transactions.filter(n=>{const s=new Date(n.created_at);return s.getFullYear()===e&&s.getMonth()===t})}updateAssets(e){this._state.assets={...this._state.assets,...e},this._save()}updateEmas(e){this._state.assets.emas={...this._state.assets.emas,...e},this._save()}updateKPR(e){this._state.assets.kpr={...this._state.assets.kpr,...e},this._save()}addArisan(e){const t=Date.now();return this._state.assets.arisan.push({id:t,...e}),this._save(),t}getAssets(){return this._state.assets}getTotalBalance(){return this._state.accounts.reduce((e,t)=>e+(t.balance||0),0)}getMonthlyExpenses(e,t){return this.getTransactionsByMonth(e,t).filter(n=>n.type==="expense").reduce((n,s)=>n+s.amount,0)}getMonthlyIncome(e,t){return this.getTransactionsByMonth(e,t).filter(n=>n.type==="income").reduce((n,s)=>n+s.amount,0)}getAllowanceSpent(){const e=new Date;return this.getTransactionsByMonth(e.getFullYear(),e.getMonth()).filter(t=>t.type==="expense"&&t.paid_by==="Suami").reduce((t,n)=>t+n.amount,0)}getDanaPusatBalance(){return this._state.accounts.filter(e=>e.owner_name==="Istri"||e.owner_name==="Bersama").reduce((e,t)=>e+(t.balance||0),0)}getNetWorth(){const e=this.getTotalBalance(),t=this._state.assets.emas,n=(t.bsi_gram+t.tring_gram)*t.price_per_gram,s=this._state.assets.kpr.paid;return e+n+s}getCategorySpending(e,t){const n=this.getTransactionsByMonth(e,t).filter(i=>i.type==="expense"),s={};return n.forEach(i=>{const o=i.parent_category||"Lainnya";s[o]=(s[o]||0)+i.amount}),Object.entries(s).map(([i,o])=>({name:i,amount:o})).sort((i,o)=>o.amount-i.amount)}reset(){this._state=JSON.parse(JSON.stringify(R)),localStorage.removeItem(j),this._notify()}}const c=new oe,G=5;function re(){const a=localStorage.getItem("cipta_seed_version");a&&parseInt(a)>=G||(c.reset(),c.setFamily({id:"family-001",family_name:"Adam Family",papa:"Erwin",mama:"Nihad",anak:"Adam",created_at:new Date().toISOString()}),c.updateSettings({userName:"Erwin",spouseName:"Nihad",allowanceBudget:15e5}),c.addAccount({bank_name:"BRI",owner_name:"Erwin",balance:0,is_allowance_account:!1,css_class:"bri"}),c.addAccount({bank_name:"Bank Jago",owner_name:"Bersama",balance:0,is_allowance_account:!0,css_class:"jago"}),c.addAccount({bank_name:"BSI",owner_name:"Nihad",balance:0,is_allowance_account:!1,css_class:"bsi"}),c.addAccount({bank_name:"Dompet Tunai Erwin",owner_name:"Erwin",balance:0,is_allowance_account:!0,css_class:"tunai"}),c.addAccount({bank_name:"Dompet Tunai Nihad",owner_name:"Nihad",balance:0,is_allowance_account:!0,css_class:"tunai"}),c.updateEmas({bsi_gram:0,tring_gram:0,price_per_gram:165e4}),c.updateKPR({total:0,paid:0,monthly:0,bank:"-",remaining_months:0}),localStorage.setItem("cipta_seed_version",G.toString()),console.log("Final Application Seeded Successfully."))}const ce="modulepreload",le=function(a){return"/Admfb/"+a},J={},D=function(e,t,n){let s=Promise.resolve();if(t&&t.length>0){let o=function(d){return Promise.all(d.map(p=>Promise.resolve(p).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),l=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=o(t.map(d=>{if(d=le(d),d in J)return;J[d]=!0;const p=d.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const y=document.createElement("link");if(y.rel=p?"stylesheet":ce,p||(y.as="script"),y.crossOrigin="",y.href=d,l&&y.setAttribute("nonce",l),document.head.appendChild(y),p)return new Promise((x,g)=>{y.addEventListener("load",x),y.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(o){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o}return s.then(o=>{for(const r of o||[])r.status==="rejected"&&i(r.reason);return e().catch(i)})};function de(){const a=c.getState(),e=a.settings.togetherMode;return`
  ...
  `}function ke(){var t;const a=document.getElementById("tx-modal-backdrop");document.getElementById("tx-modal-sheet");const e=document.getElementById("tx-form");window.addEventListener("open-transaction-modal",n=>{var s;xe(((s=n.detail)==null?void 0:s.type)||"expense")}),a==null||a.addEventListener("click",H),document.querySelectorAll("#tx-type-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#tx-type-chips .chip").forEach(r=>r.classList.remove("selected")),n.classList.add("selected");const s=n.dataset.type,i=document.getElementById("tx-to-account-group"),o=document.getElementById("tx-category-row");i&&(i.style.display=s==="transfer"?"":"none"),o&&(o.style.display=s==="transfer"?"none":"")})}),document.querySelectorAll("#tx-paid-by-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#tx-paid-by-chips .chip").forEach(s=>s.classList.remove("selected")),n.classList.add("selected")})}),document.querySelectorAll("#tx-for-whom-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#tx-for-whom-chips .chip").forEach(s=>s.classList.remove("selected")),n.classList.add("selected")})}),(t=document.getElementById("tx-category"))==null||t.addEventListener("change",n=>{const s=he(n.target.value),i=document.getElementById("tx-subcategory");i&&(i.innerHTML='<option value="">Pilih Sub-Kategori</option>'+s.map(o=>`<option value="${o}">${o}</option>`).join(""))}),e==null||e.addEventListener("submit",n=>{var f,E,w,_,v,h,S,b,$,I;n.preventDefault();const s=((f=document.querySelector("#tx-type-chips .chip.selected"))==null?void 0:f.dataset.type)||"expense",i=parseFloat(((E=document.getElementById("tx-amount"))==null?void 0:E.value)||0),o=((w=document.getElementById("tx-description"))==null?void 0:w.value)||"",r=parseInt((_=document.getElementById("tx-account"))==null?void 0:_.value),l=s==="transfer"?parseInt((v=document.getElementById("tx-to-account"))==null?void 0:v.value):null,d=((h=document.getElementById("tx-category"))==null?void 0:h.value)||"",p=((S=document.getElementById("tx-subcategory"))==null?void 0:S.value)||"",m=((b=document.querySelector("#tx-paid-by-chips .chip.selected"))==null?void 0:b.dataset.value)||"Suami",y=(($=document.querySelector("#tx-for-whom-chips .chip.selected"))==null?void 0:$.dataset.value)||"Bersama",x=(I=document.getElementById("tx-date"))==null?void 0:I.value,g=x?new Date(x).toISOString():new Date().toISOString(),k=c.getState();if(!i||i<=0){B("Masukkan nominal yang valid","error");return}c.addTransaction({account_id:r,to_account_id:l,amount:i,type:s,description:o,parent_category:s==="transfer"?"Transfer":d,sub_category:s==="transfer"?"Pindah Buku":p,paid_by:m,for_whom:y,is_together:k.settings.togetherMode,created_at:g}),B("✅ Transaksi berhasil disimpan!"),H(),window.dispatchEvent(new CustomEvent("data-updated"))})}function xe(a="expense"){var l;const e=document.getElementById("tx-modal-backdrop"),t=document.getElementById("tx-modal-sheet"),n=document.getElementById("tx-modal-title");(l=document.getElementById("tx-form"))==null||l.reset(),document.getElementById("tx-date").value=new Date().toISOString().slice(0,16),document.querySelectorAll("#tx-type-chips .chip").forEach(d=>{d.classList.toggle("selected",d.dataset.type===a)});const s=document.getElementById("tx-to-account-group"),i=document.getElementById("tx-category-row");s&&(s.style.display=a==="transfer"?"":"none"),i&&(i.style.display=a==="transfer"?"none":""),c.getState().settings.togetherMode&&(document.querySelectorAll("#tx-paid-by-chips .chip").forEach(d=>{d.classList.toggle("selected",d.dataset.value==="Istri")}),document.querySelectorAll("#tx-for-whom-chips .chip").forEach(d=>{d.classList.toggle("selected",d.dataset.value==="Bersama")}));const r={expense:"Tambah Pengeluaran",income:"Tambah Pemasukan",transfer:"Transfer Antar Rekening"};n&&(n.textContent=r[a]||"Tambah Transaksi"),e==null||e.classList.add("open"),t==null||t.classList.add("open")}function H(){var a,e;(a=document.getElementById("tx-modal-backdrop"))==null||a.classList.remove("open"),(e=document.getElementById("tx-modal-sheet"))==null||e.classList.remove("open")}function we(){return`
  ...
  `}let T=[];function _e(){var x,g,k;const a=document.getElementById("scan-modal-backdrop"),e=document.getElementById("scan-modal-sheet"),t=document.getElementById("scan-upload-area"),n=document.getElementById("scan-file-input"),s=document.getElementById("tab-text"),i=document.getElementById("tab-scan"),o=document.getElementById("panel-text"),r=document.getElementById("panel-scan"),l=document.getElementById("ai-key-config"),d=document.getElementById("ai-main-app"),p=document.getElementById("btn-save-key"),m=document.getElementById("ai-key-input");function y(){c.getState().settings.geminiApiKey?(l.style.display="none",d.style.display="block"):(l.style.display="block",d.style.display="none")}p==null||p.addEventListener("click",()=>{const f=m.value.trim();if(!f){B("API Key tidak boleh kosong","error");return}c.updateSettings({geminiApiKey:f}),B("API Key Berhasil Disimpan"),y()}),(x=document.getElementById("btn-force-config"))==null||x.addEventListener("click",()=>{l.style.display="block",d.style.display="none",m.value=c.getState().settings.geminiApiKey||"",m.focus()}),s==null||s.addEventListener("click",()=>{o.style.display="block",r.style.display="none",s.style.background="var(--primary-container)",s.style.color="var(--primary)",s.style.borderColor="var(--primary)",i.style.background="transparent",i.style.color="var(--on-surface-variant)",i.style.borderColor="transparent"}),i==null||i.addEventListener("click",()=>{o.style.display="none",r.style.display="block",i.style.background="var(--primary-container)",i.style.color="var(--primary)",i.style.borderColor="var(--primary)",s.style.background="transparent",s.style.color="var(--on-surface-variant)",s.style.borderColor="transparent"}),window.addEventListener("open-scan-modal",()=>{a==null||a.classList.add("open"),e==null||e.classList.add("open"),y(),U()}),a==null||a.addEventListener("click",()=>{a==null||a.classList.remove("open"),e==null||e.classList.remove("open")}),(g=document.getElementById("btn-analyze-text"))==null||g.addEventListener("click",async()=>{var E,w;const f=(w=(E=document.getElementById("ai-text-input"))==null?void 0:E.value)==null?void 0:w.trim();if(!f){B("Silakan ceritakan pengeluaran Anda dulu","error");return}Y();try{await W(f,null,null)}catch(_){V(_)}}),t==null||t.addEventListener("click",()=>n==null?void 0:n.click()),n==null||n.addEventListener("change",async f=>{var _;const E=(_=f.target.files)==null?void 0:_[0];if(!E)return;Y();const w=new FileReader;w.onload=async v=>{let h=v.target.result;try{h=await Ee(h)}catch(S){console.warn("Compression failed, using original",S)}document.getElementById("scan-preview-img").src=h,document.getElementById("scan-preview").style.display="block";try{await W(null,h.split(",")[1],"image/jpeg")}catch(S){V(S)}},w.readAsDataURL(E)}),(k=document.getElementById("scan-save-btn"))==null||k.addEventListener("click",()=>{if(!T||T.length===0)return;const f=c.getAccounts(),w=c.getState().settings.togetherMode;let _=0;T.forEach(v=>{var b;let h=(b=f.find($=>$.bank_name.toLowerCase().includes("tunai")))==null?void 0:b.id;if(v.account_guess){const $=v.account_guess.toLowerCase(),I=f.find(P=>P.bank_name.toLowerCase().includes($));I&&(h=I.id)}!h&&f.length>0&&(h=f[0].id);let S=null;if(v.type==="transfer"&&v.to_account_guess){const $=v.to_account_guess.toLowerCase(),I=f.find(P=>P.bank_name.toLowerCase().includes($));I&&(S=I.id)}c.addTransaction({account_id:h,to_account_id:S,amount:v.amount||0,type:v.type||"expense",description:v.description||"Transaksi AI",parent_category:v.category||"Lainnya",sub_category:v.sub_category||"",paid_by:w?"Nihad":"Erwin",for_whom:w?"Bersama":"Erwin",is_together:w,created_at:v.date?new Date(v.date).toISOString():new Date().toISOString()}),_++}),B(`✅ ${_} transaksi dari AI berhasil disimpan!`),a==null||a.classList.remove("open"),e==null||e.classList.remove("open"),window.dispatchEvent(new CustomEvent("data-updated")),U()})}function U(){document.getElementById("scan-preview").style.display="none",document.getElementById("scan-result").style.display="none",document.getElementById("scan-loading").style.display="none",document.getElementById("scan-parsed-data").style.display="none",document.getElementById("scan-save-btn").style.display="none",document.getElementById("ai-text-input").value="",document.getElementById("scan-file-input").value="",T=[]}function Y(){document.getElementById("scan-loading").style.display="block",document.getElementById("scan-result").style.display="none";const a=document.getElementById("ai-key-config");a&&(a.style.display="none");const e=document.getElementById("ai-main-app");e&&(e.style.display="block")}function V(a){console.error("AI Error:",a),document.getElementById("scan-loading").style.display="none",document.getElementById("scan-result").style.display="block";let e="❌ Maaf, Gagal memproses AI. Silakan coba deksripsi yang lebih jelas.";a.message&&(a.message.includes("403")||a.message.includes("leaked")||a.message.includes("Forbidden"))&&(e=`
    ...
    `,c.updateSettings({geminiApiKey:""})),document.getElementById("scan-ai-text").innerHTML=e,document.getElementById("scan-parsed-data").style.display="none",document.getElementById("scan-save-btn").style.display="none"}async function W(a,e,t){var g,k,f,E,w,_;const s=c.getState().settings.geminiApiKey;if(!s)throw new Error("API Key Missing");const i=`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${s}`,o=C.map(v=>v.name).join(", "),r=c.getAccounts();let p=[{text:`Anda adalah Asisten Keuangan Keluarga 'Adam Family'. Tugas Anda mengekstrak transaksi dari cerita informal (bahasa gaul/sehari-hari) atau gambar struk.
...
INPUT: "${a||"Analisis gambar struk lampiran"}"`}];e&&p.push({inlineData:{mimeType:t||"image/jpeg",data:e}});const m=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:p}],generationConfig:{temperature:.1,maxOutputTokens:2048}})});if(!m.ok){const h=((g=(await m.json().catch(()=>({}))).error)==null?void 0:g.message)||m.statusText;throw m.status===403?new Error("403 Forbidden: API Key Problem"):m.status===404?new Error("404 Not Found: Model name error"):m.status===503?new Error("503 Service Busy: Server Google penuh, coba lagi sesaat lagi."):new Error(`HTTP Error ${m.status}: ${h}`)}const x=((_=(w=(E=(f=(k=(await m.json()).candidates)==null?void 0:k[0])==null?void 0:f.content)==null?void 0:E.parts)==null?void 0:w[0])==null?void 0:_.text)||"";document.getElementById("scan-loading").style.display="none",document.getElementById("scan-result").style.display="block";try{const v=x.match(/\[[\s\S]*\]/)||x.match(/\{[\s\S]*\}/);if(!v)throw new Error("AI memberikan respon teks saja, bukan data transaksi.");let h=JSON.parse(v[0]);if(Array.isArray(h)||(h=[h]),T=h,T.length===0)throw new Error("Data transaksi kosong.");document.getElementById("scan-ai-text").innerHTML=`
      <strong>✨ AI Selesai Menganalisis!</strong><br/>
      Saya menemukan ${T.length} transaksi dari cerita Anda.
    `;const S=document.getElementById("scan-parsed-data");S.style.display="block",S.innerHTML=T.map(b=>{const $=r.find(P=>P.id==b.account_id)||{bank_name:"Unknown"},I=b.to_account_id?r.find(P=>P.id==b.to_account_id):null;return`
        <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px; margin-top: 12px; border: 1px solid var(--outline-variant);">
          <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
            ...
            <span style="font-weight: 800; color: ${b.type==="income"?"var(--success)":b.type==="transfer"?"var(--primary)":"var(--error)"};">${u(b.amount||0)}</span>
          </div>
          <div style="font-size: 13px; color: var(--on-surface-variant);">
            ...
            <p>💳 Rekening: <strong>${$.bank_name} ${I?"➡️ "+I.bank_name:""}</strong></p>
          </div>
        </div>
      `}).join(""),document.getElementById("scan-save-btn").style.display="flex"}catch(v){throw console.error(v,x),new Error("Gagal membaca data: "+v.message)}}function Ee(a,e=1200){return new Promise((t,n)=>{const s=new Image;s.src=a,s.onload=()=>{const i=document.createElement("canvas");let o=s.width,r=s.height;o>e&&(r=Math.round(r*e/o),o=e),i.width=o,i.height=r,i.getContext("2d").drawImage(s,0,0,o,r),t(i.toDataURL("image/jpeg",.8))},s.onerror=n})}function Se(){const a=c.getState(),e=new Date,t=a.settings.allowanceBudget||15e5,n=c.getAllowanceSpent(),s=Math.max(0,t-n),i=L(n,t),o=c.getDanaPusatBalance(),r=c.getMonthlyExpenses(e.getFullYear(),e.getMonth()),l=c.getMonthlyIncome(e.getFullYear(),e.getMonth());return`
    <div class="bento-grid stagger-children">
      ...
      <div class="card card-gradient" id="card-allowance">
        ...
        <div class="card-value">${u(s)}</div>
        <div class="card-subtitle">Terpakai ${u(n)} dari ${u(t)}</div>
      ...
      <div class="card" id="card-total-balance">
        ...
        <div class="card-value" style="font-size: 1.5rem; color: var(--primary);">${u(c.getTotalBalance())}</div>
      ...
      <div class="card" id="card-cash-flow">
        ...
        <div style="display: flex; gap: 12px; margin-top: 8px;">
          <div>
            ...
            <div style="font-size: 14px; font-weight: 700; color: var(--success);">${u(l,!0)}</div>
          </div>
          <div>
            <div style="font-size: 11px; color: var(--error); font-weight: 600;">▼ Keluar</div>
            <div style="font-size: 14px; font-weight: 700; color: var(--error);">${u(r,!0)}</div>
          </div>
        </div>
      </div>
    </div>
  `}function Ie(a){const e=a.toLowerCase();return e.includes("bri")?"bri":e.includes("jago")?"jago":e.includes("bsi")?"bsi":"default"}function $e(a){const e=a.toLowerCase();return e.includes("bri")?"BRI":e.includes("jago")?"JGO":e.includes("bsi")?"BSI":a.slice(0,3).toUpperCase()}function Be(){return`
    ...
    <div class="bank-slider" id="bank-slider">
      ${c.getAccounts().map(e=>{const t=Ie(e.bank_name);return`
          <div class="bank-card ${t}" data-account-id="${e.id}">
            <div class="bank-card-icon ${t}">${$e(e.bank_name)}</div>
            <div class="bank-card-name">${e.bank_name}</div>
            <div class="bank-card-owner">${e.owner_name}</div>
            <div class="bank-card-balance">${u(e.balance)}</div>
          </div>
        `}).join("")}
  ...
  `}function Ae(){const a=document.getElementById("btn-add-account");a&&a.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-account-modal"))});const e=document.getElementById("btn-manage-accounts");e&&e.addEventListener("click",()=>{D(async()=>{const{default:t}=await Promise.resolve().then(()=>ie);return{default:t}},void 0).then(({default:t})=>t.navigate("/accounts"))})}function Te(){const a=c.getState(),e=new Date,t=c.getTransactionsByMonth(e.getFullYear(),e.getMonth()),n=a.assets.kpr,s=L(n.paid,n.total),i=6e5,o=t.filter(m=>m.type==="expense"&&m.parent_category==="Transportasi").reduce((m,y)=>m+y.amount,0),r=L(o,i),l=8e5,d=t.filter(m=>m.type==="expense"&&m.for_whom==="Anak").reduce((m,y)=>m+y.amount,0),p=L(d,l);return`
    <div class="section-header">
    ...
    <div style="display: flex; flex-direction: column; gap: 12px;" class="stagger-children">
      ...
      <div class="analysis-card">
        ...
        <div class="analysis-card-detail">
          <span>Lunas: ${u(n.paid,!0)}</span>
          <span>Total: ${u(n.total,!0)}</span>
        </div>
      </div>
      ...
      <div class="analysis-card">
        ...
        <div class="analysis-card-detail">
          <span>Terpakai: ${u(o,!0)}</span>
          <span>Budget: ${u(i,!0)}</span>
        </div>
      </div>
      ...
      <div class="analysis-card">
        <div class="analysis-card-header">
          ...
          <span class="analysis-card-value" style="color: var(--success);">${p}%</span>
        </div>
        <div class="progress-bar">
          <div class="progress-bar-fill green" style="width: ${p}%;"></div>
        </div>
        <div class="analysis-card-detail">
          <span>Terpakai: ${u(d,!0)}</span>
          <span>Budget: ${u(l,!0)}</span>
        </div>
      </div>
    </div>
  `}function F(a=10,e={}){let t=c.getTransactions(e);const n=t.length;if(a&&(t=t.slice(0,a)),t.length===0)return`
      <div class="empty-state">
        <span class="material-icons-round">receipt_long</span>
        <h3>Belum Ada Transaksi</h3>
        <p>Mulai catat pengeluaran dan pemasukan Anda</p>
      </div>
    `;const s=ee(t);let i="";return Object.entries(s).forEach(([o,r])=>{i+=`<div class="transaction-group-header">${o}</div>`,r.forEach(l=>{const d=fe(l.parent_category),p=l.type,m=l.type==="expense"?"-":l.type==="income"?"+":"↔",y=c.getAccountById(l.account_id),x=y?y.bank_name:"";i+=`
        <div class="transaction-item" data-tx-id="${l.id}">
          <div class="transaction-icon ${p}">
          ...
          <div class="transaction-amount">
            <div class="transaction-amount-value ${p}">${m} ${u(l.amount)}</div>
            <div class="transaction-amount-account">${x}</div>
          </div>
        </div>
      `})}),a&&n>a&&(i+=`
    ...
    `),i}function O(){document.querySelectorAll(".transaction-item").forEach(a=>{a.addEventListener("click",()=>{const e=a.dataset.txId;window.dispatchEvent(new CustomEvent("view-transaction",{detail:{id:e}}))})})}function Pe(){const a=c.getState();return`
  ...
  `}function Le(){Ae(),O()}function Me(){const a=new Date().getHours();return a<11?"Selamat Pagi":a<15?"Selamat Siang":a<18?"Selamat Sore":"Selamat Malam"}let A={};function ze(){const a=new Date,e=c.getMonthlyExpenses(a.getFullYear(),a.getMonth()),t=c.getMonthlyIncome(a.getFullYear(),a.getMonth()),n=t-e;return`
    <div class="page-container animate-fade-in" id="transactions-page">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; margin-bottom: 20px;">
        <div style="background: var(--success-container); border-radius: var(--radius-md); padding: 12px; text-align: center;">
          ...
          <div style="font-size: 14px; font-weight: 800; color: var(--success); margin-top: 4px;">${u(t,!0)}</div>
        </div>
        <div style="background: var(--error-container); border-radius: var(--radius-md); padding: 12px; text-align: center;">
          ...
          <div style="font-size: 14px; font-weight: 800; color: var(--error); margin-top: 4px;">${u(e,!0)}</div>
        </div>
        <div style="background: var(--primary-container); border-radius: var(--radius-md); padding: 12px; text-align: center;">
          ...
          <div style="font-size: 14px; font-weight: 800; color: ${n>=0?"var(--success)":"var(--error)"}; margin-top: 4px;">${u(n,!0)}</div>
        </div>
      </div>
  ...
  `}function De(){O(),document.querySelectorAll("#tx-filters .chip").forEach(e=>{e.addEventListener("click",()=>{document.querySelectorAll("#tx-filters .chip").forEach(n=>n.classList.remove("selected")),e.classList.add("selected");const t=e.dataset.filter;t==="all"?delete A.type:A.type=t,K()})}),document.querySelectorAll("#tx-paid-filter .chip").forEach(e=>{e.addEventListener("click",()=>{document.querySelectorAll("#tx-paid-filter .chip").forEach(n=>n.classList.remove("selected")),e.classList.add("selected");const t=e.dataset.paid;t==="all"?delete A.paid_by:A.paid_by=t,K()})});const a=document.getElementById("tx-search");a&&a.addEventListener("input",te(e=>{const t=e.target.value.trim();t?A.search=t:delete A.search,K()},300)),Ce()}function K(){const a=document.getElementById("filtered-transactions");a&&(a.innerHTML=F(null,A),O())}async function Ce(){const a=document.getElementById("category-chart");if(a)try{const e=await D(()=>import("./auto-eE5P6S0m.js"),[]),t=e.default||e.Chart,n=new Date,s=c.getCategorySpending(n.getFullYear(),n.getMonth());if(s.length===0){a.parentElement.innerHTML=`
    ...
    <div class="page-container animate-fade-in" id="accounts-page">
      ...
      <div class="net-worth-card" style="margin-bottom: 20px;">
        ...
        <div class="net-worth-value">${u(e)}</div>
  ...
  `}function Re(a){const e=ae(a.bank_name);return`
    <div class="card" style="display: flex; align-items: center; gap: 16px; cursor: pointer;" data-acc-id="${a.id}">
      ...
      <div style="text-align: right;">
        <div style="font-weight: 800; font-size: var(--fs-body); color: var(--primary);">${u(a.balance)}</div>
      </div>
  ...
  `}function Ne(){var t;const a=document.getElementById("btn-add-new-account"),e=document.getElementById("acc-modal-backdrop");document.getElementById("acc-modal-sheet"),a==null||a.addEventListener("click",()=>Q()),window.addEventListener("open-account-modal",()=>Q()),e==null||e.addEventListener("click",()=>Z()),document.querySelectorAll("#acc-owner-chips .chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("#acc-owner-chips .chip").forEach(s=>s.classList.remove("selected")),n.classList.add("selected")})}),(t=document.getElementById("acc-form"))==null||t.addEventListener("submit",n=>{var l,d,p,m,y;n.preventDefault();const s=(d=(l=document.getElementById("acc-bank-name"))==null?void 0:l.value)==null?void 0:d.trim(),i=((p=document.querySelector("#acc-owner-chips .chip.selected"))==null?void 0:p.dataset.value)||"Suami",o=parseFloat(((m=document.getElementById("acc-balance"))==null?void 0:m.value)||0),r=((y=document.getElementById("acc-is-allowance"))==null?void 0:y.checked)||!1;if(!s){B("Masukkan nama bank","error");return}c.addAccount({bank_name:s,owner_name:i,balance:o,is_allowance_account:r,css_class:ae(s).replace("bank-card-icon ","")}),B("✅ Rekening berhasil ditambahkan!"),Z(),window.dispatchEvent(new CustomEvent("data-updated"))}),document.querySelectorAll(".btn-delete-account").forEach(n=>{n.addEventListener("click",s=>{s.stopPropagation();const i=parseInt(n.dataset.accId);confirm("Hapus rekening ini?")&&(c.deleteAccount(i),B("Rekening dihapus"),window.dispatchEvent(new CustomEvent("data-updated")))})})}function Q(){var a,e,t;(a=document.getElementById("acc-form"))==null||a.reset(),(e=document.getElementById("acc-modal-backdrop"))==null||e.classList.add("open"),(t=document.getElementById("acc-modal-sheet"))==null||t.classList.add("open")}function Z(){var a,e;(a=document.getElementById("acc-modal-backdrop"))==null||a.classList.remove("open"),(e=document.getElementById("acc-modal-sheet"))==null||e.classList.remove("open")}function ae(a){const e=a.toLowerCase();return e.includes("bri")?"bri":e.includes("jago")?"jago":e.includes("bsi")?"bsi":e.includes("tunai")||e.includes("cash")?"tunai":"default"}function Fe(a){const e=a.toLowerCase();return e.includes("bri")?"BRI":e.includes("jago")?"JGO":e.includes("bsi")?"BSI":e.includes("tunai")||e.includes("cash")?"CSH":a.slice(0,3).toUpperCase()}function Oe(){const a=c.getAssets(),e=c.getNetWorth(),t=c.getTotalBalance(),n=a.emas,s=n.bsi_gram+n.tring_gram,i=s*n.price_per_gram,o=a.kpr,r=L(o.paid,o.total),l=o.total-o.paid,d=a.arisan||[];return`
      ...
      <div class="net-worth-card" style="margin-bottom: 24px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; margin-top: 16px; position: relative; z-index: 1;">
          <div style="text-align: center;">
            ...
            <div style="font-size: 13px; font-weight: 700;">${u(t,!0)}</div>
          </div>
          <div style="text-align: center;">
            <div style="font-size: 11px; opacity: 0.6;">🪙 Emas</div>
            <div style="font-size: 13px; font-weight: 700;">${u(i,!0)}</div>
          </div>
          <div style="text-align: center;">
            <div style="font-size: 11px; opacity: 0.6;">🏠 KPR Equity</div>
            <div style="font-size: 13px; font-weight: 700;">${u(o.paid,!0)}</div>
          </div>
        </div>
      </div>
      ...
      <div class="asset-card" id="asset-emas">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 16px;">
          <div style="background: var(--tertiary-container); border-radius: var(--radius-md); padding: 12px;">
            ...
            <div style="font-size: 12px; color: var(--on-tertiary-container); opacity: 0.8;">${u(n.bsi_gram*n.price_per_gram,!0)}</div>
          </div>
          <div style="background: var(--tertiary-container); border-radius: var(--radius-md); padding: 12px;">
            ...
            <div style="font-size: 12px; color: var(--on-tertiary-container); opacity: 0.8;">${u(n.tring_gram*n.price_per_gram,!0)}</div>
          </div>
        </div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 12px; border-top: 1px solid var(--outline-variant);">
          ...
          <div style="text-align: right;">
            ...
            <div style="font-size: 1.25rem; font-weight: 800; color: var(--tertiary);">${u(i)}</div>
          </div>
        </div>
        ...
        <div style="margin-top: 12px; padding: 8px 12px; background: var(--surface-container); border-radius: var(--radius-sm); display: flex; align-items: center; gap: 8px;">
          ...
          <span style="font-size: 11px; color: var(--on-surface-variant);">Harga emas: ${u(n.price_per_gram)}/gram (update manual)</span>
        </div>
      </div>
      ...
      <div class="asset-card" id="asset-kpr">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
          <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px;">
            ...
            <div style="font-size: 14px; font-weight: 800; color: var(--success); margin-top: 4px;">${u(o.paid,!0)}</div>
          </div>
          <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px;">
            <div style="font-size: 11px; color: var(--on-surface-variant); font-weight: 600;">Sisa Hutang</div>
            <div style="font-size: 14px; font-weight: 800; color: var(--error); margin-top: 4px;">${u(l,!0)}</div>
          </div>
          <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px;">
            <div style="font-size: 11px; color: var(--on-surface-variant); font-weight: 600;">Cicilan/bulan</div>
            <div style="font-size: 14px; font-weight: 800; color: var(--on-surface); margin-top: 4px;">${u(o.monthly,!0)}</div>
          </div>
          <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px;">
        ...
        `:d.map(p=>`
          <div style="background: var(--surface-container); border-radius: var(--radius-md); padding: 12px; margin-bottom: 8px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
              <div style="font-weight: 700; font-size: var(--fs-body);">${p.name}</div>
              <span class="badge" style="background: ${p.is_active?"var(--success-container)":"var(--surface-container-high)"}; color: ${p.is_active?"var(--success)":"var(--outline)"};">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; font-size: 12px;">
              <div>
                ...
                <div style="font-weight: 700;">${u(p.monthly_amount,!0)}</div>
              </div>
              <div>
                <div style="color: var(--on-surface-variant);">Giliran Saya</div>
                <div style="font-weight: 700;">Ke-${p.my_turn}</div>
              </div>
              <div>
                <div style="color: var(--on-surface-variant);">Putaran</div>
                <div style="font-weight: 700;">${p.current_round}/${p.total_members}</div>
              </div>
            </div>
            <div style="margin-top: 8px;">
              <div class="progress-bar" style="height: 4px;">
                <div class="progress-bar-fill blue" style="width: ${L(p.current_round,p.total_members)}%;"></div>
              </div>
            </div>
          </div>
        `).join("")}
  ...
  `}function Ge(){}function Je(){c.getState();const a=new Date,e=qe();return`
  ...
  `}function qe(){const a=new Date,e=c.getState(),n=c.getTransactionsByMonth(a.getFullYear(),a.getMonth()).filter(g=>g.type==="expense"),s=n.reduce((g,k)=>g+k.amount,0),i=e.settings.allowanceBudget||15e5,o=c.getAllowanceSpent(),r=[],l=Math.round(o/i*100);l>=80?r.push({title:"Budget Alert",icon:"warning",color:"#e53935",message:`Pegangan ${e.settings.userName} sudah mencapai ${l}% budget. Sisa ${u(i-o)} untuk bulan ini.`,detail:`Budget: ${u(i)} | Terpakai: ${u(o)}`}):l>=50&&r.push({title:"Pemantauan Budget",icon:"info",color:"#fb8c00",message:`${e.settings.userName}, pegangan sudah terpakai ${l}%. Masih ada ${u(i-o)} untuk sisa bulan ini.`,detail:null});const d=n.filter(g=>g.parent_category==="Transportasi").reduce((g,k)=>g+k.amount,0);d>0&&r.push({title:"Transportasi",icon:"directions_car",color:"#9a6a1a",message:`Total pengeluaran transportasi bulan ini: ${u(d)}. ${d>5e5?"Cukup tinggi, pertimbangkan efisiensi perjalanan LDM.":"Masih terkendali, pertahankan!"}`,detail:null});const p=5e5,m=n.filter(g=>g.sub_category==="Groceries"||g.parent_category==="Makanan & Minuman").reduce((g,k)=>g+k.amount,0);m<p&&m>0&&r.push({title:"Apresiasi! 🎉",icon:"celebration",color:"#43a047",message:`${e.settings.spouseName}, bulan ini pengeluaran makanan & groceries ${u(m,!0)}. Hemat ${u(p-m,!0)} yang bisa dialokasikan ke investasi emas!`,detail:null});const y=n.filter(g=>g.is_together);if(y.length>0){const g=y.reduce((k,f)=>k+f.amount,0);r.push({title:"Quality Time 💕",icon:"favorite",color:"#e91e63",message:`Bulan ini ada ${y.length} transaksi saat Together Mode aktif, total ${u(g)}. Waktu berkualitas bersama keluarga itu priceless!`,detail:null})}const x=n.filter(g=>g.for_whom==="Anak").reduce((g,k)=>g+k.amount,0);return x>0&&r.push({title:"Keperluan Anak",icon:"child_care",color:"#1565c0",message:`Total pengeluaran untuk anak bulan ini: ${u(x)}. Investasi terbaik adalah pendidikan anak.`,detail:null}),r.push({title:"Ringkasan Bulanan",icon:"summarize",color:"#30609d",message:`Total pengeluaran ${z()}: ${u(s)} dari ${n.length} transaksi. Saya terus memantau dan akan memberikan insight yang lebih akurat seiring bertambahnya data.`,detail:null}),r}function He(){var n;const a=new Date,e=c.getCategorySpending(a.getFullYear(),a.getMonth());if(e.length===0)return'<div style="text-align: center; padding: 20px; color: var(--outline);">Belum ada data</div>';const t=((n=e[0])==null?void 0:n.amount)||1;return`
    <div class="card">
      ${e.map((s,i)=>{const o=Math.round(s.amount/t*100),r=["#30609d","#9a6a1a","#1b6d2f","#ba1a1a","#7b1fa2","#00695c","#e65100","#283593"],l=r[i%r.length];return`
          <div style="margin-bottom: 12px;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 4px;">
              ...
              <span style="font-size: 13px; font-weight: 700; color: ${l};">${u(s.amount,!0)}</span>
            </div>
  ...
  `}function Ue(){}const Ye=document.getElementById("app"),N={"/":{render:Pe,init:Le},"/transactions":{render:ze,init:De},"/accounts":{render:je,init:Ne},"/assets":{render:Oe,init:Ge},"/insights":{render:Je,init:Ue}};function ne(a){const e=N[a]||N["/"];Ye.innerHTML=`
    ${de()}
    ${me()}
    ${e.render()}
    ${ve()}
    ${be()}
    ${we()}
  `,ue(),ye(),ke(),_e(),e.init(),ge(a),window.scrollTo({top:0,behavior:"instant"})}Object.keys(N).forEach(a=>{M.addRoute(a,ne)});window.addEventListener("data-updated",()=>{const a=M.getCurrentPath();ne(a)});function Ve(){re(),M.start()}document.addEventListener("DOMContentLoaded",Ve);
